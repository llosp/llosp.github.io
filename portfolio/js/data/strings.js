...
export const strings = {
  ...
  "case.team":       { en: "Team", pt: "Time" },
  "case.studio":     { en: "Studio", pt: "Estúdio" },
  "case.engine":     { en: "Engine", pt: "Engine" },
  ...
  "tuner.output":  { en: "Output /s", pt: "Produção /s" },
  "tuner.time":    { en: "Time (min)", pt: "Tempo (min)" }
};
...
export const skillGroups = [
  ...
  {
    title: { en: "Economy & Balance", pt: "Economia e Balanceamento" },
    items: [
      { en: "Economy design", pt: "Design de economia" },
      { en: "Sources & sinks", pt: "Fontes & sumidouros" },
  ...
  },
  {
    ...
    items: [
      { en: "Unity", pt: "Unity" },
      { en: "Godot", pt: "Godot" },
      { en: "C# / GDScript", pt: "C# / GDScript" },
      { en: "Godot Resources", pt: "Godot Resources" },
      { en: "ScriptableObjects", pt: "ScriptableObjects" },
